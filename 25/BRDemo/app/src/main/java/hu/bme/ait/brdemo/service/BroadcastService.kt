package hu.bme.ait.brdemo.service
...
import hu.bme.ait.brdemo.AirPlaneReceiver
import hu.bme.ait.brdemo.BootReceiver
import hu.bme.ait.brdemo.MainActivity
import hu.bme.ait.brdemo.MyBroadcastReceiver
import hu.bme.ait.brdemo.R
import hu.bme.ait.brdemo.ScreenReceiver
    ...
    inner class MyTimeThread : Thread() {
        override fun run() {
            ...
            while (enabled) {
                ...
                handlerMain.post {
                    Toast.makeText(
                        this@BroadcastService, dateTime,
                        Toast.LENGTH_LONG
                    ).show()
                }
