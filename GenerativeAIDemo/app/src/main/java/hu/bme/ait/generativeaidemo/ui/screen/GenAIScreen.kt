...
fun GenAIScreen(
    ...
    var textPrompt by rememberSaveable { mutableStateOf(
        "Állapítsd meg igen/nem-el, hogy az következő című cikk pozitív vagy negatív-e szerinted. " +
                "A cikk címe: Don Corleone fia az Indexnek: Apám jó szülő volt, nincs miért bocsánatot kérnem") }
