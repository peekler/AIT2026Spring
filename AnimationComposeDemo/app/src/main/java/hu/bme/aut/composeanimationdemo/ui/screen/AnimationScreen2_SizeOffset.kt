...
fun AnimationScreen2() {
    ...
    val size by animateDpAsState(
        ...
        keyframes {
            durationMillis = 6000
            sizeState * 2.0f at 500 with LinearEasing
            sizeState * 0.5f at 1000 with LinearEasing
            sizeState * 1.0f at 2000 with LinearEasing
            sizeState * 2.0f at 3000 with LinearEasing
            sizeState * 1.0f at 6000 with LinearEasing
        }, label = "size"
    )
